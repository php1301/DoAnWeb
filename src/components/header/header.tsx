...
const Header: FC<{ isDark?: boolean }> = () => {
                                ...
                                <div>
                                    <Link href="/#">
                                        <a className="px-3 ml-7 font-size-7 notification-block flex-y-center position-relative">
                                            ...
                                            <span className="font-size-3 count font-weight-semibold text-white bg-primary circle-24 border-width-3 border border-white">
                                                3
                                            </span>
                                        </a>
                                    </Link>
