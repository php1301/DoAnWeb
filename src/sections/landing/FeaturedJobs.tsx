...
import imgF1 from "@public/assets/image/svg/icon-leaf.svg";
import imgF2 from "@public/assets/image/svg/text-Fimize.svg";
import imgF3 from "@public/assets/image/svg/icon-shark-2.svg";
import imgF4 from "@public/assets/image/svg/text-K.svg";
import imgF5 from "@public/assets/image/svg/icon-thunder.svg";
import imgF6 from "@public/assets/image/svg/text-asios.svg";
...
const FeaturedJobs: FC<FeaturedJobsProps> = ({ viecLams, count }) => {
    return (
        <>
            {/* <!-- FeaturedJobs Area -->  */}
