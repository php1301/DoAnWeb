...
import imgT1 from "@public/assets/image/l3/png/testimonial.png";
import imgTB from "@public/assets/image/l3/png/testimonial-brand-logo.png";
                                            ...
                                            <div className="slide-content pl-5 pl-lg-10 pl-xxl-20 pr-5 pr-xl-5 py-lg-5 py-9">
                                                ...
                                                <div className="">
                                                    <p className="font-size-6 text-black-2 pr-5 mb-10">
                                                        ...
                                                        to definitely do a lot
                                                        more with less. And when
                                                        you want to create a
                                                        business bigger than
                                                        yourself, you’re going
                                                        to need help. And that’s
                                                        what Justcamp does.”
                                                    </p>
                                                    {/* <!-- User Info --> */}
                                                    <div className="">
